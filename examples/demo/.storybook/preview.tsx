...
import { createMockTelegram } from "../src/telegram/mock";
...
const preview: Preview = {
  ...
  globalTypes: {
    ...
    roundness: {
      description: "Corner radius multiplier",
      defaultValue: "1",
      toolbar: {
        title: "Round",
        icon: "circle",
    ...
    density: {
      description: "Story layout density",
