...
/* Simplified iOS device frame (bezel, dynamic island, status bar, home
   indicator) — demo chrome only, intentionally not part of the kit. */
...
function StatusBar({ dark = false, time = "9:41" }: { dark?: boolean; time?: string }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ width: 126 }} />
      <div style={{ flex: 1, height: 22, display: "flex", alignItems: "center", justifyContent: "center", gap: 7, paddingTop: 1 }}>
